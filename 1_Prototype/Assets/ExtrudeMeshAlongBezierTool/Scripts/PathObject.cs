...
public class PathObject : MonoBehaviour
{
    ...
    public void UpdateNewMesh()
    {
        ...
        void GetNewMeshData()
        {
            ...
            float widthOfMeshMinValue = float.MaxValue*5f;
            float widthOfMeshMaxValue = float.MinValue*1f;
            ...
            MeshWidth = Mathf.Abs(widthOfMeshMinValue) + Mathf.Abs(widthOfMeshMaxValue);  //þimdi
